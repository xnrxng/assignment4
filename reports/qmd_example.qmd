...
![Horse populations for all provinces in Canada from 1906 - 1972.](../results/horse_pops_plot.png){#fig-horse-pops width=90%}
...
We present the standard deviations in @tbl-horses-sd-table.

```{r}
#| label: tbl-horses-sd-table
...
Additionally, note that in @tbl-horses-sd-table we consider the sample standard deviation of the number of horses during the same time span as @fig-horse-pops.

![Horse populations for the province with the largest standard deviation.](../results/horse_pop_plot_largest_sd.png){#fig-horse-sd width=60%}
